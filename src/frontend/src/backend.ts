...
import type { CartItem as _CartItem, Category as _Category, Order as _Order, OrderStatus as _OrderStatus, PaymentMethod as _PaymentMethod, Product as _Product, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async placeOrder(arg0: Array<CartItem>, arg1: string, arg2: PaymentMethod): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.placeOrder(arg0, arg1, to_candid_PaymentMethod_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitReturnRequest(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "COD" in value ? PaymentMethod.COD : "Online" in value ? PaymentMethod.Online : value;
}
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Budget" in value ? Category.Budget : "Luxury" in value ? Category.Luxury : "Sport" in value ? Category.Sport : "Kids" in value ? Category.Kids : "Fitness" in value ? Category.Fitness : value;
}
